<?php $this->Html->addCrumb(__('Tasks'), ['action' => 'index'], ['icon' => ['class' => 'fa fa-tasks fa-fw']]); ?>
	<div class="toolbar toolbar-default">
		...
		<div class="btn-group">
			...
			<ul class="dropdown-menu">
				...
				<li><?= $this->Html->link(__('Responsible'), ['admin' => true, 'action' => 'responsible'],
		...
		<?= $this->Html->link(__('Export'), ['action' => 'export'], [
			'class' => 'btn btn-info btn-sm',
			'icon' => ['class' => 'fa fa-bolt fa-fw'],
		]); ?>
	</div>
				...
				<?php foreach ($tasks as $id => $task) : ?>
					<tr>
						...
						<td class="actions">
							...
							<?= $this->Element->btnLinkEdit($task['Task']['id'], '', ['class' => ['btn-xs']]); ?>
