...
<nav class="toolbar toolbar-default" role="navigation">
	...
	<?= $this->Element->btnToolbarEdit($task['Task']['id']); ?>
	<?= $this->Element->btnToolbarMail($task['Task']['id']); ?>
	<?= $this->Element->btnLinkDelete($task['Task']['id'], __('Delete'),
...
<div class="row">
	<div class="col-md-6 col-lg-8">
		<ul class="nav nav-tabs nav-tabs-remote">
			<li class="active">
				<?= $this->Html->link(__('Actions'),
					['admin' => true, 'controller' => 'task_actions', 'action' => 'related', $task['Task']['id']], [
						'icon' => ['class' => 'fa fa-comments fa-fw"'],
						'data-toggle' => 'tab',
						'data-target' => '#task-action-tab-related',
					]) ?>
			</li>
		</ul>
