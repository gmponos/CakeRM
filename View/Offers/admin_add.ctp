<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="row">
			<div class="col-sm-6">
				<?php echo $this->Form->input('user_id', ['selected' => $this->Session->read('Auth.User.id'), 'class' => 'form-control form-control-chosen']);?>
			</div>
			<div class="col-sm-6">
		...
		<div class="row">
			<div class="col-sm-3">
				<?php echo $this->Form->file('File', ['type' => 'file', 'label' => 'Upload File', 'after'=>__('Please first compress the file to upload it.')]);?>
			</div>
		</div>
