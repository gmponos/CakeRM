...
<div class="row">
	...
	<div class="col-sm-9 col-md-10">
		...
		<dl class="dl-table">
			...
			<dd>
				<?php echo h($dayOff['DayOff']['id']);?>
			</dd>
			<dt><?php echo __('User');?></dt>
			<dd>
				<?php echo $this->Html->link($dayOff['User']['fullname'], ['controller' => 'users', 'action' => 'view', $dayOff['User']['id']]);?>
			</dd>
			...
			<dd>
				<time><?php echo h($dayOff['DayOff']['modified']);?></time>
				&nbsp;
			</dd>
		</dl>
	</div>
