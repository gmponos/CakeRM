	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-body">
				<?php
				echo $this->Form->create('Task', ['type' => 'get']);
				...
				<div class="row">
					<div class="col-sm-6"><?php echo $this->Form->datepicker('date_start', ['label' => __('From Date')]);?></div>
					<div class="col-sm-6"><?php echo $this->Form->datepicker('date_end', ['label' => __('To Date')])?></div>
				</div>
			</div>
			<div class="modal-footer">
				<?php echo $this->Form->button(__('Export'), ['type' => 'submit', 'class' => 'btn btn-success btn-sm']);?>
