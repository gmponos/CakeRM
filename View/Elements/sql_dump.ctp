...
?>
<button class="btn btn-warning" type="button" data-toggle="collapse" data-target="#sql-dump-table">
	<span class="fa fa-cog fa-fw"></span>
</button>
<hr/>
<div id="sql-dump-table" class="well well-sm collapse">
<?php
if ($noLogs || isset($_forced_from_dbo_)) :
	foreach ($sqlLogs as $source => $logInfo) :
		$text = $logInfo['count'] > 1 ? 'queries' : 'query';
		printf(
			'<table class="cake-sql-log table table-hover small" id="cakeSqlLog_%s" summary="Cake SQL Log">',
