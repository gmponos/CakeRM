		...
		<table class="table table-hover table-striped small">
			...
			<tbody>
				<?php foreach ($bankAccounts as $bankAccount) : ?>
					<tr>
						<td><?= h($bankAccount['BankAccount']['id']); ?>&nbsp;</td>
						<td>
						...
						<td class="text-center"><?= $this->Html->status($bankAccount['BankAccount']['business']); ?>
							&nbsp;</td>
						<td><?= h($bankAccount['BankAccount']['created']); ?>&nbsp;</td>
						<td><?= h($bankAccount['BankAccount']['updated']); ?>&nbsp;</td>
						<td class="actions">
							<?= $this->Element->btnLinkView($bankAccount['BankAccount']['id']); ?>
							<?= $this->Element->btnLinkEdit($bankAccount['BankAccount']['id']); ?>
							<?= $this->Element->btnLinkDelete($bankAccount['BankAccount']['id']); ?>
						</td>
					</tr>
				<?php endforeach; ?>
			</tbody>
